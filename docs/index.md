---
layout: default
title: Liberation System - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Liberation System</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/liberation-system" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
# Run container
docker run -p 8080:8080 liberation-system
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/liberation-system)
